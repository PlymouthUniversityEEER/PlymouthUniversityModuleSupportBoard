    ...
    #define STEREO_RIGHT_AN_PIN     PC_1
    ...
    // BUTTONS *
    // *********
    #define BTN1_PIN PB_14
    #define BTN2_PIN PD_10
    #define BTN3_PIN PG_10
    #define BTN4_PIN PG_8
    ...
    #define DIP0_PIN    PG_9
    #define DIP1_PIN    PG_12
    #define DIP2_PIN    PE_14
    #define DIP3_PIN    PG_14
